        ...
        {item.item_name && (
            ...
            <div className="container-fluid mt-5 py-4 px-xl-5">
                ...
                <div className="d-lg-block col-lg-1 order-sm-2 order-xs-2 order-lg-1 ">
                    <div
                    className="GVB60-vertical-scroller"
            ...
            <div className="container-fluid">
                ...
                <hr />
            <p>{item.item_desc}</p>
                <div className="container-fluid GVB60Img">
                    <div className="container-fluid" style={{position:"relative"}}>
                        <div className="GVB60Details" style={{color:"#fff"}}>
                            <h1><strong>GeekVape B60</strong></h1>
                            <h3>New Tri-proof. Empower Boost</h3>
                        </div>
                    </div>
                </div>

                <div className="container-fluid GVB60Img2">
                    <div className="container-fluid GVB60Details2" style={{position:"relative"}}>
                            <p className="GVB60-p2" style={{color:"#000"}}>
                            Stunningly leakproof design.
                            <br />
                            Intelligent working modes by AS-Chip.
                            <br />
                            A fresher look with 0.96-inch LED curved display.
                            <br />
                            A safer carry with A-lock.
                            <br />
                            This is the new boost with new tri-proof.
                            </p>
                            <img
                            className="GVB60Logo2"
                            src={GVB60Icon2}
                            alt="" />
                    </div>
                </div>
