        ...
        {item.item_name && (
            ...
            <div className="container-fluid mt-5 py-4 px-xl-5">
                ...
                <div className="d-lg-block col-lg-1 order-sm-2 order-xs-2 order-lg-1 ">
                    <div
                    className="DigiUKit-vertical-scroller"
            ...
            <div className="container-fluid">
                ...
                <hr />
            <p>{item.item_desc}</p>
                <div className="container-fluid DigiUKitImg">
                    <div className="container-fluid" style={{position:"relative"}}>
                        <div className="DigiUKitDetails">
                        <h1>DIGI-U POD KIT</h1>
                        <br />
                        <p>Introducing a stylish portable pod vape case. The customized pattern stands for a free Digiflavor style. A simple side slide is made for simple airflow control. 1000mAh battery supports a whole-day use. It looks chic with the lanyard that comes in the package. Enjoy a play-cool vape!</p>
                        </div>
                    </div>
                </div>
            </div>
