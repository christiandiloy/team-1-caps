...
import "./css/gv-s100.css";
import GVS100Icon2 from '../../assets/images/item-pages-details/s100-02-icon.png';
        ...
        {item.item_name && (
            ...
            <div className="container-fluid mt-5 py-4 px-xl-5">
                ...
                <div className="d-lg-block col-lg-1 order-sm-2 order-xs-2 order-lg-1 ">
                    <div
                    className="GVS100-vertical-scroller"
                ...
                <div className="col-lg-5 order-sm-3">
                    ...
                    <div className="row g-3 mb-4">
                        <div className="col">
                        <button className="btn customBtn py-2 w-100" onClick={() => handleAddToCart(19)}>
                            Add to cart
                        </button>
                        </div>
                    </div>
            ...
            <div className="container-fluid">
                ...
                <hr />
            <p>{item.item_desc}</p>
                <div className="container-fluid GVS100Img">
                    <div className="container-fluid" style={{position:"relative"}}>
                        <div className="GVS100Details">
                        <h1>GeekVape S100</h1>
                        </div>
                    </div>
                </div>

                <div className="container-fluid GVS100Img2">
                    <div className="container-fluid GVS100Details2" style={{position:"relative"}}>
                            <p className="GVS100-p2" style={{color:"#000"}}>
