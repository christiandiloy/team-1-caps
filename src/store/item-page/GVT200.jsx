...
import "./css/gv-t200.css";
import GVT200Icon2 from '../../assets/images/item-pages-details/t200-02-icon.png';
        ...
        {item.item_name && (
            ...
            <div className="container-fluid mt-5 py-4 px-xl-5">
                ...
                <div className="d-lg-block col-lg-1 order-sm-2 order-xs-2 order-lg-1 ">
                    <div
                    className="GVT200-vertical-scroller"
                ...
                <div className="col-lg-5 order-sm-3">
                    ...
                    <div className="row g-3 mb-4">
                        <div className="col">
                        <button className="btn customBtn py-2 w-100" onClick={() => handleAddToCart(20)}>
                            Add to cart
                        </button>
                        </div>
                    </div>
            ...
            <div className="container-fluid">
                ...
                <hr />
            <p>{item.item_desc}</p>
                <div className="container-fluid GVT200Img">
                    <div className="container-fluid" style={{position:"relative"}}>
                        <div className="GVT200Details">
                        <h1>GeekVape T200</h1>
                        </div>
                    </div>
                </div>

                <div className="container-fluid GVT200Img2">
                    <div className="container-fluid GVT200Details2" style={{position:"relative"}}>
                            <p className="GVT200-p2" style={{color:"#000"}}>
                            GEEKVAPE T200 (Aegis Touch) pleases your eyes with a large 2.4-inch
                            <br />
                            full touch screen that vividly displays 4 dynamic UI themes.
                            <br />
                            The brand new Z coils allow double service life of up to 60ml.
                            <br />
                            Explore the “touching” wonders and double your vaping fun now!
                            </p>
                            <img
                            className="GVT200Logo2"
                            src={GVT200Icon2}
                            alt="" />
                    </div>
                </div>
